    ...
    className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          <h1 className='flex-1 font-poppins font-semibold ss:text-[4.5rem] 
          text-[3.2rem] text-white ss:leading-[100px] leading-[4.6rem]'>The Next <br className='sm:block hidden '/>{' '} 
        ...
        <h1 className=' font-poppins font-semibold ss:text-[4.2rem] 
          text-[3.2rem] text-white ss:leading-[6rem] leading-[4.6rem] w-full'>
            Payment Method
        </h1>
