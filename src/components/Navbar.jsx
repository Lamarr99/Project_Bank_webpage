...
const Navbar = () => {
  ...
  return (
    <nav 
    className='w-full flex py-6 justify-between items-center navbar sticky'>
      <img src={logo} alt=""
      ...
      className='list-none sm:flex hidden justify-end items-center flex-1'>
          {navLinks.map((nav, index) => (
            ...
            text-[16px] hover:text-secondary ease-in-out duration-[.3s]
      ...
      <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        <div className={`${toggle ? 'flex' : 'hidden'} 
          ...
          <ul 
            ...
            text-white hover:text-secondary ease-in-out duration-[.3s]`}>
              <a href={`#${nav.id}`}>{nav.title}</a>
            </li>
            ) )}
          </ul>
